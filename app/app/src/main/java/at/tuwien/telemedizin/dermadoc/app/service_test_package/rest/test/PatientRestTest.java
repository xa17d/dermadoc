package at.tuwien.telemedizin.dermadoc.app.service_test_package.rest.test;
...
import at.tuwien.telemedizin.dermadoc.app.service_test_package.rest.IRestCaseService;
import at.tuwien.telemedizin.dermadoc.app.service_test_package.rest.IRestLoginService;
import at.tuwien.telemedizin.dermadoc.app.service_test_package.rest.RestCaseService;
...
public class PatientRestTest {
    ...
    private void startOtherTests(AuthenticationToken token) {
        ...
        Case newCaseB = new Case();
        newCaseB.setName("a new case");
        final Case newCase = newCaseB;
